...
const faqData: FAQItem[] = [
  ...
  },
  {
    category: '遊戲玩法',
    question: '如何參加組隊副本？',
    answer: '組隊副本目前採用 AI 隊友機制，不是即時組隊。加入好友可以獲得更多助戰點數，讓你的隊伍更強大。副本會掉落珍貴的代幣和稀有裝備，是中後期提升戰力的重要途徑。'
  },
  {
    category: '遊戲玩法',
    question: '區域 Boss 什麼時候會出現？',
    answer: '區域 Boss 會在混亂值滿了之後出現。混亂值由所有玩家的探索行為累積，大家一起探索就會讓混亂值上升，達到滿值時 Boss 就會現身。擊敗 Boss 可獲得豐厚獎勵。'
  },
  // 儲值與商城
  {
    category: '儲值與商城',
    question: '遊戲免費嗎？',
    answer: 'LineHero 是免費遊戲，所有核心內容都可以免費體驗。'
  },
  {
    category: '儲值與商城',
  ...
  },
  {
    ...
    answer: '為維護遊戲公平性，我們不建議使用多開或模擬器。使用第三方工具可能導致帳號被停權。另外，因為遊戲使用 LINE 平台，須遵守 LINE 官方規章，惡意刷訊息有機會被 LINE 官方封鎖帳號，這部分非本遊戲所能處理。'
  },
];
