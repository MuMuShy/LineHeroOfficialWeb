      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        ...
        <div className="flex-1 text-center lg:text-left pt-10 lg:pt-0">
          ...
          <div className="mt-12 grid grid-cols-2 gap-4 max-w-md mx-auto lg:mx-0">
            <div className="glass-panel rounded-2xl px-5 py-4 border border-white/10 bg-white/5">
              <div className="flex items-center gap-3 text-xs uppercase tracking-[0.3em] text-gray-400">
                <span className="w-2 h-2 rounded-full bg-hero-green"></span>
                線上玩家
              </div>
              <div className="mt-2 text-2xl font-black text-white font-mono">1,204</div>
            </div>
            <div className="glass-panel rounded-2xl px-5 py-4 border border-white/10 bg-white/5">
              <div className="flex items-center gap-3 text-xs uppercase tracking-[0.3em] text-gray-400">
                <span className="w-2 h-2 rounded-full bg-hero-gold"></span>
                今日戰鬥
              </div>
              <div className="mt-2 text-2xl font-black text-white font-mono">45,201</div>
            </div>
          </div>
        </div>
            ...
            <div className="absolute inset-0 rounded-[32px] overflow-hidden bg-gray-900 flex flex-col">
              ...
              <div className="flex-1 p-4 relative overflow-hidden flex flex-col">
                ...
                <div className="absolute inset-0 opacity-50">
                  <img src="https://image.linehero.tw/images/tower/endless_tower_bg_landscape-w320.webp" className="w-full h-full object-cover" alt="bg" />
                ...
                <div className="relative mt-8 mx-auto w-32 h-32 animate-pulse-slow">
                  ...
                  <img src="https://image.linehero.tw/images/regions/boss/boss_girl2_small-w256.webp" alt="Boss" className="relative z-10 w-full h-full object-contain drop-shadow-lg filter brightness-110" />
                  {/* Health Bar */}
                ...
                <div className="mt-auto relative z-10">
                  <div className="bg-gray-800/80 backdrop-blur border border-gray-700 rounded-lg p-3 mb-3 flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full border-2 border-white/20 overflow-hidden">
                      <img src="https://image.linehero.tw/images/hero_avatar/character_warrior2-w64.webp" alt="Avatar" className="w-full h-full object-cover" />
                    </div>
