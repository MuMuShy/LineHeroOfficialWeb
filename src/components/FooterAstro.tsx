        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <a href={link.href} className="hover:text-hero-gold transition-colors">
                    {link.label}
                  </a>
                </li>
              ))}
              <li>
                <a
                  ...
                  className="hover:text-hero-gold transition-colors flex items-center gap-1"
