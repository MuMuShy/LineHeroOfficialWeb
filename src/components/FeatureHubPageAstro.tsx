  ...
  >
    ...
    <section className="mt-12 md:mt-16">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
        {[
          { src: '/images/screenshots/linehero-screenshot-2.webp', title: '傳奇冒險者養成' },
          { src: '/images/screenshots/linehero-screenshot-1.webp', title: '仙鶴騎士對戰' },
          { src: '/images/screenshots/linehero-screenshot-3.webp', title: '天龍戰士對戰' },
          { src: '/images/screenshots/linehero-screenshot-4.webp', title: '戰鬥結算與技能紀錄' },
          { src: '/images/screenshots/linehero-screenshot-5.webp', title: '鐵匠鋪詞綴重鑄' },
          { src: '/images/screenshots/linehero-screenshot-6.webp', title: 'PVP 對戰' },
          { src: '/images/screenshots/linehero-screenshot-7.webp', title: '副本 Boss 掉落' },
          { src: '/images/screenshots/linehero-screenshot-8.webp', title: '圖鑑與怪物資訊' },
        ].map((shot) => (
