        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="flex-1 space-y-6 md:space-y-8 w-full">
            ...
            <div className="flex items-center justify-between mb-2 px-1">
              <span className="text-xs text-gray-400 font-mono tracking-wide">選擇您的英雄</span>
              <span className="text-xs text-hero-gold/70 animate-pulse flex items-center gap-1">
                <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
                更多角色
              </span>
            </div>
            <div className="flex gap-4 pt-2 overflow-x-auto pb-4 no-scrollbar mx-[-24px] px-6 md:mx-0 md:px-0 scroll-smooth">
              {characters.map((char) => (
                <button
                  key={char.id}
